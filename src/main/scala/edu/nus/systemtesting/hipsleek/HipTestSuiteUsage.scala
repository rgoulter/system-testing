...
//  )
  ...
  val ParahipTests = List(
    test(command, "parahip/parahip/simple.ss", "--en-para -tp parahip --en-lsmu-infer --en-thrd-and-conj", "func: SUCCESS, main: SUCCESS"),
    test(command, "parahip/parahip/forkjoin.ss", "--en-para -tp parahip --en-lsmu-infer --en-thrd-and-conj", "func: SUCCESS, main: SUCCESS"),
    test(command, "parahip/parahip/cell4.ss", "--en-para -tp parahip --en-lsmu-infer --en-thrd-and-conj", "inc: SUCCESS, main: SUCCESS"),
    test(command, "parahip/parahip/cell-lock-vperm.ss", "--en-para -tp parahip --en-lsmu-infer --en-thrd-and-conj", "testCell: SUCCESS, testVar: FAIL"),
    test(command, "parahip/parahip/ls-bind.ss", "--en-para -tp parahip --en-lsmu-infer --en-thrd-and-conj", "func: SUCCESS, main: SUCCESS"),
    test(command, "parahip/parahip/ls-waitlevel2.ss", "--en-para -tp parahip --en-lsmu-infer --en-thrd-and-conj", "func2: SUCCESS, func3: SUCCESS, func4: SUCCESS"),
    test(command, "parahip/parahip/double-acquire.ss", "--en-para -tp parahip --en-lsmu-infer --en-thrd-and-conj", "func: SUCCESS, main: FAIL"),
    test(command, "parahip/parahip/no-deadlock1.ss", "--en-para -tp parahip --en-lsmu-infer --en-thrd-and-conj", "func: SUCCESS, main: SUCCESS"),
    test(command, "parahip/parahip/no-deadlock2.ss", "--en-para -tp parahip --en-lsmu-infer --en-thrd-and-conj", "func: SUCCESS, main: SUCCESS"),
    test(command, "parahip/parahip/no-deadlock3.ss", "--en-para -tp parahip --en-lsmu-infer --en-thrd-and-conj", "func: SUCCESS, main: SUCCESS"),
    test(command, "parahip/parahip/deadlock1.ss", "--en-para -tp parahip --en-lsmu-infer --en-thrd-and-conj", "func: SUCCESS, main: FAIL"),
    test(command, "parahip/parahip/deadlock2.ss", "--en-para -tp parahip --en-lsmu-infer --en-thrd-and-conj", "func: SUCCESS, main: FAIL"),
    test(command, "parahip/parahip/deadlock3.ss", "--en-para -tp parahip --en-lsmu-infer --en-thrd-and-conj", "func: SUCCESS, main: FAIL"),
    test(command, "parahip/parahip/disj-no-deadlock1.ss", "--en-para -tp parahip --en-lsmu-infer --en-thrd-and-conj", "func: SUCCESS, main: SUCCESS"),
    test(command, "parahip/parahip/disj-no-deadlock2.ss", "--en-para -tp parahip --en-lsmu-infer --en-thrd-and-conj", "func: SUCCESS, main: SUCCESS"),
    test(command, "parahip/parahip/disj-no-deadlock3.ss", "--en-para -tp parahip --en-lsmu-infer --en-thrd-and-conj", "func: SUCCESS, main: SUCCESS"),
    test(command, "parahip/parahip/disj-deadlock.ss", "--en-para -tp parahip --en-lsmu-infer --en-thrd-and-conj", "func: SUCCESS, main: FAIL"),
    test(command, "parahip/parahip/multicast.ss", "--en-para -tp parahip --en-lsmu-infer --en-thrd-and-conj", "initialize: SUCCESS, thread: SUCCESS"),
    test(command, "parahip/parahip/oracle.ss", "--en-para -tp parahip --en-lsmu-infer --en-thrd-and-conj", "thread: SUCCESS, main: SUCCESS"),
    test(command, "parahip/parahip/owicki-gries.ss", "--en-para -tp parahip --en-lsmu-infer --en-thrd-and-conj", "incrementor2: SUCCESS, incrementor1: SUCCESS, main: SUCCESS"),
    test(command, "parahip/parahip/fibonacci.ss", "--en-para -tp parahip --en-lsmu-infer --en-thrd-and-conj", "seq_fib: SUCCESS, para_fib: SUCCESS"),
    test(command, "parahip/parahip/create_and_acquire.ss", "--en-para -tp parahip --dis-locklevel --en-thrd-and-conj", "create_and_acquire: SUCCESS")
  )
