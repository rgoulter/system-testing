...
class SleekTestSuiteUsage(
  ...
  val SleekTests = List(
    ...
    test(command, "sleek3.slk", "--elp", "Valid, Fail, Valid"),
    test(command, "sleek4.slk", "", "Valid, Valid"),
    test(command, "sleek6.slk", "", "Valid, Valid"),
    test(command, "sleek7.slk", "--dis-lem-gen", "Valid, Valid, Valid, Fail, Valid, Valid, Valid, Valid, Fail, Valid"),
    test(command, "sleek8.slk", "--dis-lem-gen", "Valid, Valid, Valid, Valid, Valid, Valid, Valid, Valid, Valid, Fail, Valid, Valid, Valid, Valid, Fail, Valid, Fail"),
    test(command, "sleek8.slk", "--elp", "Valid, Valid, Valid, Valid, Valid, Valid, Valid, Valid, Valid, Fail, Valid, Valid, Valid, Valid, Fail, Valid, Fail"),
    test(command, "sleek9.slk", "--elp", "Valid, Fail, Valid, Valid"),
    ...
    test(command, "lst-under2.slk", "--inv-test", "Valid, Fail"),
    test(command, "data-holes.slk", "", "Fail, Valid, Valid"),
    test(command, "ll-under1a.slk", "--inv-test --use-baga", ""),
    test(command, "ll-under1b.slk", "--inv-test --use-baga", ""),
    test(command, "ll-under1c.slk", "--inv-test --use-baga", ""),
    test(command, "ll-under1d.slk", "--inv-test --use-baga", ""),
    test(command, "ll-under1e.slk", "--inv-test --use-baga", ""),
    test(command, "ll-under1f.slk", "--inv-test --use-baga", ""),
    ...
    test(command, "inflem.slk", "--en-inf --elp --dis-eps --dis-inv-baga", "Fail, Valid"),
    test(command, "lemmas/sort2.slk", "--elp --dis-lem-gen", ""),
    test(command, "lemmas/lseg.slk", "--elp --dis-lem-gen", ""),
    test(command, "lemmas/lseg1.slk", "--elp --dis-lem-gen", ""),
    test(command, "lemmas/rlseg.slk", "--elp --dis-lem-gen --old-empty-to-conseq", ""),
    test(command, "lemmas/lemma-fold.slk", "--elp", "Valid, Fail, Valid, Fail, Valid, Fail"),
    test(command, "lemmas/rd-lem-1.slk", "--elp --dis-lem-gen", ""),
    test(command, "lemmas/rd-lem-2.slk", "", "Fail"),
    test(command, "lemmas/app-tail.slk", "--elp", "Valid, Fail"),
    test(command, "lemmas/lseg_case.slk", "--elp --dis-lem-gen", ""),
    test(command, "lemmas/ll.slk", "--elp", "Valid, Fail"),
    test(command, "lemmas/ll_tail.slk", "--elp", "Valid, Valid"),
    test(command, "lemmas/nlseg3.slk", "", "Valid, Valid"),
    test(command, "lemmas/nlseg4e.slk", "--elp", ""),
    test(command, "lemmas/nlseg4e1.slk", "--dis-imm", "Valid, Valid, Valid, Fail, Valid, Valid, Valid, Valid"),
    test(command, "lemmas/sll_tailL.slk", "--elp", ""),
    test(command, "lemmas/dseg-new.slk", "--elp --dis-lem-gen --old-empty-to-conseq", ""),
    test(command, "lemmas/dseg1.slk", "--elp --dis-lem-gen", ""),
    test(command, "lemmas/odd-lseg.slk", "--elp --dis-lem-gen --dis-eps", "Fail, Valid, Valid, Fail, Valid, Fail, Valid"),
    test(command, "lemmas/lseg_complex.slk", "--elp --dis-lem-gen --old-empty-to-conseq", "Valid, Valid, Fail"),
